...
class SysState(object):
    ...
    def create_servers(self, sim: Simulation, num_servers: int, service_rates: list, seeds: list):
        ...
        #######################################
        # DONE Task 3.1.4: Modify code below.
        return [Server(sim, service_rates[i], seeds[i]) for i in range(num_servers)]
        #######################################
    ...
    def create_users(self, sim: Simulation, num_users: int, arrival_rates: list, seeds: list):
        ...
        #######################################
        # DONE Task 3.1.4:
        # print('create users:', arrival_rates, seeds, num_users)
        # print('sim:', sim)
        # print(seeds)
        # seeds = [2,2]
        return [User(sim, arrival_rates[i], seeds[i]) for i in range(num_users)]
        #######################################
