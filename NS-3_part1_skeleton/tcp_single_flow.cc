...
main(int argc, char *argv[]) {
    ...
    // < ---- TODO Bonus Task 6.1.3: set tcp variant, error rate and delay via command line ---- >
    ...
    // < ---- TODO  Task 6.1.1: Set error rate ---- >
    ...
    // < ---- TODO  Task 6.1.2: Set TCP version ---- >
    ...
    // < ---- TODO  Task 6.1.2: Setup the application ---- >
    ...
    // < ---- TODO  Task 6.1.2: Connect trace for congestion window ---- >
    ...
    // < ---- TODO  Task 6.1.2: Connect trace for packet drops ---- >

    // Run simulation
    // < ---- TODO  Task 6.1.4: Run the simulation ---- >
    Simulator::Destroy();
