...
main(int argc, char *argv[]) {
    ...
    // < ---- TODO  Task 6.2.2:  Set TCP version ---- >
    ...
    // < ---- TODO  Task 6.2.2: Create sockets and app for flow 1 and install on node---- >


    // -------- Flow 2 --------
    Address sinkAddress2(InetSocketAddress(if_rx2s2.GetAddress(1), sinkPort));
    // < ---- TODO  Task 6.2.2: Create sockets and app for flow 2 and install on node ---- >
    ...
    /* -------- Traces and Output -------- */
    // < ---- TODO  Task 6.2.2: Add traces and output writer ---- >
    ...
    // < ---- TODO  Task 6.2.5: Increase the delay of link to Receiver 1---- >

    // Run simulation and stop after 60s
    // < ---- TODO  Task 6.2.3: run simulation ---- >
